...
KEYSTORE_FILENAME="keystore.jks.${hostname}"
VALIDITY_IN_DAYS=3650
DEFAULT_TRUSTSTORE_FILENAME="truststore.jks${hostname}"
TRUSTSTORE_WORKING_DIRECTORY="truststore-${hostname}"
...
---
EOFKEYSTORE
rm $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_FILENAME.base64  $TRUSTSTORE_WORKING_DIRECTORY/$DEFAULT_TRUSTSTORE_FILENAME.base64  
